/*
  Rellena esto después de:
    1. Crear un proyecto en https://supabase.com
    2. Pegar y ejecutar supabase-schema.sql en el SQL Editor del proyecto
    3. Copiar la URL y la clave "anon public" desde Project Settings → API

  IMPORTANTE: aquí va SOLO la clave "anon public". Nunca la "service_role".
